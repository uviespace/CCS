    # STEP $testStepNumber --------------------------------------------------------------------------------------------------------
    def step_$testStepNumber(self, ccs, pool_name, start_cuc=None, tc_id=None):
        ...
        report.verification_step_begin(step_param=param, script_version=self.version(), ccs=ccs, pool_name=pool_name, step_start_cuc=step_start_cuc)
