...
class TstAppWindow(Gtk.ApplicationWindow):
    ...
    def __init__(self, logger=logger, *args, **kwargs):
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(os.path.join(cfg.get('paths', 'ccs'), 'pixmap/x-office-spreadsheet.svg'), 28, 28)
        icon = Gtk.Image.new_from_pixbuf(pixbuf)
        self.btn_export_csv.set_icon_widget(icon)
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(os.path.join(cfg.get('paths', 'ccs'), 'pixmap/text-x-python.svg'), 28, 28)
        icon = Gtk.Image.new_from_pixbuf(pixbuf)
        self.btn_generate_script.set_icon_widget(icon)
